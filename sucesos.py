...
import pygame_gui 
from pygame import *
from Boton_juego import boton
from Imagen import Imagen
from Nodo import Nodo
from Stack import Stack
from ClaseHitbox import hitbox
...
class poker:
    ...
    def definir(self):
        CARD_WIDTH = 130
        CARD_HEIGHT = 180
        card_2 = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/2.png', 2)
        card_3 = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/3.png', 3)
        card_4 = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/4.png', 4)
        card_5 = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/5.png', 5)
        card_6 = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/6.png', 6)
        card_7 = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/7.png', 7)
        card_8 = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/8.png', 8)
        card_9 = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/9.png', 9)
        card_10 = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/10.png', 10)
        card_A = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/A.png', 14)
        card_back = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/back.png', 0)
        card_J = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/J.png', 11)
        card_k = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/K.png', 12)
        card_Q = Imagen(0, 0, CARD_WIDTH, CARD_HEIGHT, 'img/Q.png', 12)
        ...
        self.lista_ganadora = [card_A, card_k, card_Q, card_J, card_10, card_9, card_8, card_7, card_6, card_5, card_4, card_3, card_2]
...
class arbol:
    ...
    def definir(self):
        ...
        self.text_field = TextFeild('valor', 20, 40, 120, 23)
...
class grafo:
    def __init__(self, SCREEN, width, height):
        ...
        self.peso_input = TextFeild("peso", 70, self.height - 40, 100, 30)
        self.mi_grafo = None

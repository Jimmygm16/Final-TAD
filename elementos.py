...
class ComboBox:
    ...
    def deploy(self, screen):
        ...
        temp_text = fuente.render(self.selected_item, True, (0,0,0))
        ...
        if self.deployed:
            ...
            pg.draw.rect(screen, (255,255,255), (self.size.x, self.size.y + self.size.height, self.size.width, self.size.height + (len(self.options)-1) * yDelta), 0)
            for i in range(len(self.options)):
                ...
                temp_text = fuente.render(self.options[i], True, (0,0,0))
